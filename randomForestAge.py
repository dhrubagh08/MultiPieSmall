...
def ageTest():
	...
	f1 = open('RandomForestCompareResAge.txt','w+')		
	...
	pickle.dump(clf,open('age_multipie_rf_calibrated.p','wb'))
	...
	print imageNumbers
	with open('rf_age_imageProbabilities.csv', 'wb') as f:
		writer = csv.writer(f)	
	...
	with open('rf_age_threhsolds.csv', 'wb') as f:
		writer = csv.writer(f)	
