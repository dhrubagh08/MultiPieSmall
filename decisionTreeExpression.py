...
def expressionTest():
	f1 = open('DTCompareResExpressionMultipie.txt','w+')
	...
	joblib.dump(clf,open('expression_multipie_dt_calibrated.p','wb'))
	...
	print imageNumbers
	with open('dt_expression_imageProbabilities.csv', 'wb') as f:
		writer = csv.writer(f)	
	...
	plt.savefig('rocExpressionDTMultipie.png')	
	plt.show()
