...
def expressionTest():
	...
	f1 = open('ETCompareResExpressionMultipie.txt','w+')
	...
	pickle.dump(clf,open('expression_multi_pie_et_calibrated.p','wb'))
	...
	print imageNumbers
	with open('et_expression_imageProbabilities.csv', 'wb') as f:
		writer = csv.writer(f)	
	...
	with open('et_thresholds_expression.csv', 'wb') as f:
		writer = csv.writer(f)	
	...
	plt.savefig('rocExpressionET.png')	
	plt.show()
