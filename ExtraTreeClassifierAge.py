...
def ageTest():
	...
	f1 = open('ETCompareResAgeMultipie.txt','w+')
	...
	pickle.dump(clf,open('age_multi_pie_et_calibrated.p','wb'))
	...
	print imageNumbers
	with open('et_age_imageProbabilities.csv', 'wb') as f:
		writer = csv.writer(f)	
	...
	with open('et_thresholds_age.csv', 'wb') as f:
		writer = csv.writer(f)	
