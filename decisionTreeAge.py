...
def ageTest():
	f1 = open('DTCompareResAgeMultipie.txt','w+')
	...
	joblib.dump(clf,open('age_multipie_dt_calibrated.p','wb'))
	...
	print imageNumbers
	with open('dt_age_imageProbabilities.csv', 'wb') as f:
		writer = csv.writer(f)	
	...
	plt.savefig('rocAgeDTMultipie.png')	
	plt.show()
