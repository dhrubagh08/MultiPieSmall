...
def genderTest():
	...
	f1 = open('KnnCompareResGenderMultiPie.txt','w+')		
	...
	joblib.dump(clf,open('gender_multipie_knn_calibrated.p','wb'))
	
	'''
	
	clf = joblib.load(open('gender_multipie_knn_calibrated.p', 'rb'))
	testX,testY = pickle.load(open('MultipieValidationGender_XY.p','rb'))
	tn = time.time()
