...
def expressionTest():
	...
	pickle.dump(clf,open('expression_multipie_gnb_calibrated.p','wb'))
	...
	print imageNumbers
	with open('gnb_expression_imageProbabilities.csv', 'wb') as f:
		writer = csv.writer(f)	
	...
	with open('gnb_expression_thresholds.csv', 'wb') as f:
		writer = csv.writer(f)	
	...
	plt.savefig('rocExpressionGNB.png')	
	plt.show()
