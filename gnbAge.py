...
def ageTest():
	...
	f1 = open('GnbCompareResAgeMultiPie.txt','w+')		
	...
	pickle.dump(clf,open('age_multipie_gnb_calibrated.p','wb'))
	...
	print imageNumbers
	with open('gnb_age_imageProbabilities.csv', 'wb') as f:
		writer = csv.writer(f)	
	...
	with open('gnb_age_thresholds.csv', 'wb') as f:
		writer = csv.writer(f)	
